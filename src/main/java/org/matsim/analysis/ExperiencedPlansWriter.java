...
public class ExperiencedPlansWriter implements MATSimAppCommand {
    ...
    private String network = "/Users/paulh/git/matsim-berlin-ph/output/10pct-no-pt/berlin-v6.4.output_network.xml.gz";

    @CommandLine.Option(names = "--population", description = "Path to population")
    private String population = "/Users/paulh/git/matsim-berlin-ph/output/10pct-no-pt/berlin-v6.4.output_plans_selected.xml.gz";

    @CommandLine.Option(names = "--transit-schedule", description = "Path to transit schedule")
    private String transitSchedule = "/Users/paulh/git/matsim-berlin-ph/output/10pct-no-pt/berlin-v6.4.output_transitSchedule.xml.gz";

    @CommandLine.Option(names = "--events", description = "Path to events file")
    private Path eventsFile = Path.of("/Users/paulh/git/matsim-berlin-ph/output/10pct-no-pt-rust/events.0.xml.gz");

    @CommandLine.Option(names = "--output", description = "Path to output experienced plans file")
    private String output = "/Users/paulh/git/matsim-berlin-ph/output/10pct-no-pt-rust/experienced-plans.xml.gz";
