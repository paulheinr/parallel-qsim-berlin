...
public class ExperiencedPlansWriter implements MATSimAppCommand {
    ...
    private String network = "/Users/paulh/git/parallel-qsim-berlin/output/v6.4/0.1pct/berlin-v6.4-network-with-pt.xml.gz";

    @CommandLine.Option(names = "--population", description = "Path to population")
    private String population = "/Users/paulh/git/parallel-qsim-berlin/output/v6.4/0.1pct/berlin-v6.4-0.1pct.plans-filtered.xml.gz";
